# Predictive Directional SFANC for Moving Sources
This repository will host the official open-source code of our work:
**Predictive Directional Selective Fixed-Filter Active Noise Control for Moving Sources via a Convolutional Recurrent Neural Network** *(submitted to Interspeech 2026)*.
